...
namespace omnibazaar {
    ...
    // Operation for Founder Bonuses.
    struct founder_bonus_operation : public graphene::chain::base_operation
    {
...
FC_REFLECT( omnibazaar::founder_bonus_operation::fee_parameters_type, (fee) )
FC_REFLECT( omnibazaar::founder_bonus_operation, (fee)(payer)(extensions) )
